        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                    <form method="POST" id="signup-form" class="signup-form " action="Registration" class="was-validated"">
                        <h2 class="form-title">Create account</h2>
                        <div class="form-group ">
                            <input type="text" class="form-input" name="Fname" id="Fname" placeholder="First Name" required/>
                        </div>
                         <div class="form-group ">
                            <input type="text" class="form-input" name="Lname" id="Lname" placeholder="Last Name" required/>
                        </div>
                        <div class="form-group ">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                            <input type="text" class="form-input" name="num" id="num" pattern="[7-9]{1}[0-9]{9}"  placeholder="Contact Number"  required/>
                      <span id="mobile"
                        ...
                        <span id="chec" class="text-danger font-weight-thin"></span>
                        </div>
                        <div class="form-group">
