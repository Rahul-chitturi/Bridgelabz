   ...
   <table >
     ...
     ResultSet full = (ResultSet)request.getAttribute("fulltable");
      ...
      <tr>
         ...
         <button type="submit"  class=" nav-link btn btn-info">Edit </button>
         </form></td>
         <td><form action="Delete" method="post">
         <input type="hidden" name="delete" value = "<%=full.getString("Id")%>">
         <button type="submit"  class=" nav-link btn btn-info">Delete </button>
         </form></td>
      </tr>
     <%
      }
